  ...
  return (
    <section className="relative overflow-hidden pb-16 pt-20 sm:pt-28">
      <div className="pointer-events-none absolute inset-0 -z-10">
        <div className="absolute left-1/2 top-[-10%] h-[520px] w-[520px] -translate-x-1/2 rounded-full bg-primary/15 blur-[120px]" />
      </div>
      <div className="container">
        ...
        <Heading className="text-balance text-5xl font-semibold leading-tight sm:text-6xl md:text-7xl">
          ...
          <br />
          <span className="bg-gradient-to-r from-zinc-200 to-slate-400 bg-clip-text text-transparent">
