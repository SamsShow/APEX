...
export function AIStrategyAdvisor({ onStrategySelect, className = '' }: AIStrategyAdvisorProps) {
      ...
      {isAnalyzing && (
        <Card className="bg-zinc-900/50 border-zinc-700">
          <CardContent className="text-center py-12">
            ...
            <h3 className="text-lg font-medium text-zinc-200 mb-2">Analyzing Market Conditions</h3>
            <p className="text-zinc-400">
              Our AI is analyzing current market data, volatility patterns, and sentiment to provide
